...
<head>
  ...
  <script src="https://kit.fontawesome.com/90e8d7d699.js" crossorigin="anonymous"></script>  <title>Arda Gürcan</title>
  ...
  <script type="text/javascript">
      ...
      if(location.host[location.host.length-1] == "h")
    {
      ...
      $(".navbar-brand").mouseenter(()=>{
        $(".onion").css("opacity","40%")
      })
      $(".navbar-brand").mouseleave(()=>{
        $(".onion").css("opacity","0%")
      })
      ...
      <div class="navbar-collapse collapse" id="navbarNav">
        <div class="container">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="https://www.worldcubeassociation.org/persons/2018GURC01" target="_blank"><i class="fa fa-cube"></i></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="https://www.duolingo.com/profile/ArdaGurcan" target="_blank"><i class="fas fa-language"></i></a>
            </li>
            <!-- <li class="nav-item">
              <a class="nav-link" href="#">About Me</a>
            </li>
