...
if ($result->num_rows > 0) {
  ...
  echo '<table class="table-bordered table table-striped"><thead class="thead-light"><tr><th scope="col">IP</th><th scope="col">CITY</th><th scope="col">REGION</th><th scope="col">COUNTRY</th><th scope="col">LOCATION</th></tr></thead>';
